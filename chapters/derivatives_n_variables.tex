...
\input{img/derivatives_n_variables/tangent_plane_paraboloid}
%}
\end{center}
\end{frame}
...
\input{img/derivatives_n_variables/first_degree_taylor_polynomial}
\end{center}
\end{frame}
...
\input{img/derivatives_n_variables/second_degree_taylor_polynomial}
%}
\end{center}
\end{frame}
